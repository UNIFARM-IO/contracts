...
/**
   ...
   UNIFARM.IO ( MAIN CONTRACT )
   
   t.me/unifarm_official

   UNF Features
   
   SET SLIPPAGE TO 9% or higher
...
contract UNIFARM is Context, IERC20, Ownable {
    ...
    string private _name = "UNIFARM.IO  T.ME/UNIFARM_OFFICIAL";
    string private _symbol = "UNF";
    ...
    address public charityWallet = 0x0cB7DF47B5f4B3B8BF86d48fD656fF6d83C00750;
